...
import 'package:fuodz/component/button/custom_steppr.view.dart';
import 'package:fuodz/component/card/custom.visibility.dart';
import 'package:fuodz/component/custom_image.view.dart';
import 'package:fuodz/component/input/drop_down.input.dart';
import 'package:fuodz/component/states/product_stock.dart';
import 'package:fuodz/component/tags/discount.positioned.dart';
            ...
            CustomVisibilty(
              ...
              child:
                  HStack([
                    ...
                    CustomVisibilty(
                      visible: widget.product.selectedQty < 1,
                      child: Icon(Icons.add, size: 20).box.p4
