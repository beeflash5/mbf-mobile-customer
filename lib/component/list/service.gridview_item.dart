...
import 'package:fuodz/component/card/vendor_info.view.dart';
import 'package:fuodz/component/custom_image.view.dart';
import 'package:fuodz/component/states/alternative.view.dart';
  ...
  Widget build(BuildContext context) {
    return VStack([
          Stack(
            children: [
              AlternativeView(
                ismain: service.photos.isNotEmpty,
                main: CustomImage(
              ...
              Positioned(
                ...
                child:
                    ((service.hasOptions ? "From".tr() : "") +
                        ...
                        .box
                        .roundedLg
                        .border(width: 1.6, color: Utils.textColorByTheme())
