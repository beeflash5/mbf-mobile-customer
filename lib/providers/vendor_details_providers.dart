...
class VendorDetailsController extends FamilyAsyncNotifier<Vendor, int> {
  ...
  Future<Vendor> build(int arg) async {
    return ref.read(_vendorRequestProvider).vendorDetails(
      arg,
      params: {'type': 'small'},
    );
  }
...
final vendorDetailsControllerProvider = AsyncNotifierProvider.family<
    VendorDetailsController, Vendor, int>(VendorDetailsController.new);
