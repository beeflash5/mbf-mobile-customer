...
class VendorCategoryProductsState {
  ...
  VendorCategoryProductsState copyWith({
    ...
    productsBySubcategory: productsBySubcategory ?? this.productsBySubcategory,
...
class VendorCategoryProductsController
    extends
        FamilyAsyncNotifier<
          VendorCategoryProductsState,
          VendorCategoryProductsArgs
        > {
  ...
  Future<VendorCategoryProductsState> build(
    ...
    final pages = <int, int>{};
    await Future.wait(
      arg.category.subcategories.map((sub) async {
        try {
  ...
  Future<void> refreshSubcategory(int subcategoryId) async {
    ...
    state = AsyncData(
      cur.copyWith(
        ...
        pagesBySubcategory: {...cur.pagesBySubcategory, subcategoryId: 1},
      ),
    );
  }
  ...
  Future<void> loadMore(int subcategoryId) async {
    ...
    state = AsyncData(
      cur.copyWith(loadingMore: {...cur.loadingMore, subcategoryId: true}),
    );
...
final vendorCategoryProductsControllerProvider = AsyncNotifierProvider.family<
  ...
  VendorCategoryProductsState,
  VendorCategoryProductsArgs
>(VendorCategoryProductsController.new);
