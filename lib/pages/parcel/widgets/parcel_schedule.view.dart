      ...
      child:
          VStack([
            HStack([
                ...
                .wFull(context)
                .onInkTap(
                  () => controller.toggleScheduledOrder(!state.isScheduled),
                ),
            Visibility(
              ...
              child: VStack([
                ...
                CustomListView(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Jiffy.parseFromDateTime(dateDeliverySlot.date)
                        ...
                        .make()
                        .onInkTap(
                          () => controller.changeSelectedDeliveryDate(
                            formattedDeliverySlot,
                            index,
                          ),
                        );
                ...
                CustomGridView(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final selected =
                        formattedTime == state.packageCheckout.deliverySlotTime;
                    return Jiffy.parse("$today $availableTimeSlot")
                        ...
                        .make()
                        .onInkTap(
                          () => controller.changeSelectedDeliveryTime(
                            formattedTime,
                          ),
                        );
                  },
