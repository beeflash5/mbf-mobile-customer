        ...
        VStack(
          [
            ...
            DottedBorder(
              ...
              child: ParcelDeliveryDiscountSection(
                state: state,
            ...
            CustomVisibilty(
              ...
              child: VStack(
                [
                  AmountTile(
                    "Distance".tr(),
                    "${co.distance?.numCurrency} km",
                  ),
                  AmountTile(
                    "Delivery Charges".tr(),
                    "${controller.currencySymbol} ${co.deliveryFee}"
                        .currencyFormat(),
                  ),
                  AmountTile(
                  ...
                  AmountTile(
                    "Discount".tr(),
                    "- ${controller.currencySymbol} ${co.discount}"
                        .currencyFormat(),
                  ),
                  const DottedLine().py12(),
                  AmountTile(
                    "Tax".tr() + " (${co.taxRate}%)",
                    "${controller.currencySymbol} ${co.tax ?? ''}"
                        .currencyFormat(),
                  ),
                  VendorFeesView(
                    fees: co.fees,
