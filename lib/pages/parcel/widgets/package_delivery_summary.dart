          ...
          [
            ...
            VStack(
              [
                ...
                Visibility(
                  visible: AppStrings.enableParcelMultipleStops,
                  child: (state.packageCheckout.stopsLocation != null)
                      ? VStack(
                        ...
                        [
                          VStack(
                            [
                              ...
                              "${controller.packageWeightTEC.text}kg"
                                  .text
                                  .make(),
                            ],
                          ).expand(),
                          VStack(
                            [
                              ...
                              "${controller.packageLengthTEC.text}cm"
                                  .text
                                  .make(),
                            ],
                          ).expand(),
                        ...
                        [
                          VStack(
                            [
                              ...
                              "${controller.packageWidthTEC.text}cm"
                                  .text
                                  .make(),
                            ],
                          ).expand(),
                          VStack(
                            [
                              ...
                              "${controller.packageHeightTEC.text}cm"
                                  .text
                                  .make(),
                            ],
                          ).expand(),
