...
class _ServiceBookingSummaryPageState
  ...
  Widget build(BuildContext context) {
    final state =
        ref.watch(serviceBookingSummaryControllerProvider(widget.service));
              ...
              if (service.selectedOptions.isNotEmpty)
                VStack([
                  ...
                  ListView(
                    ...
                    children: service.selectedOptions.map((option) {
                      return HStack([
                          ...
                          return Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () =>
                                      controller.decrementGuest(agePrice.id),
                                  child: Container(
                                    width: 28,
                                    height: 28,
                                    decoration: BoxDecoration(
                                ...
                                GestureDetector(
                                  onTap: () =>
                                      controller.incrementGuest(agePrice.id),
                                  child: Container(
                                    width: 28,
                                    height: 28,
                                    decoration: BoxDecoration(
