...
class NewDeliveryAddressesPage extends ConsumerStatefulWidget {
  const NewDeliveryAddressesPage({super.key});

  @override
  ConsumerState<NewDeliveryAddressesPage> createState() =>
      _NewDeliveryAddressesPageState();
}

class _NewDeliveryAddressesPageState
    extends ConsumerState<NewDeliveryAddressesPage> {
  ...
  final DeliveryAddress _deliveryAddress = DeliveryAddress();
  ...
  Future<void> _save() async {
    ...
    final result = await ref
        .read(newDeliveryAddressControllerProvider.notifier)
        .save(_deliveryAddress);
    if (!mounted) return;
