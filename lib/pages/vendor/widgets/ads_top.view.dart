...
class AdsTop extends ConsumerStatefulWidget {
  const AdsTop(
    this.vendorType, {
  ...
  @override
  ConsumerState<AdsTop> createState() => _AdsTopState();
}

class _AdsTopState extends ConsumerState<AdsTop> {
  @override
  Widget build(BuildContext context) {
    final args = (vendorTypeId: widget.vendorType?.id ?? 0, slot: 1);
