...
import 'package:fuodz/component/list/food_vendor.list_item.dart';
...
class SectionVendorsView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isLoading = asyncVendors.isLoading;
