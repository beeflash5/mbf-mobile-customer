              ...
              ? Column(
                  ...
                  children: [
                    "Hi, ${currentUser?.name ?? ""}!"
                        ...
                        .color(Colors.black)
                        .make(),
                    "Explore the real Bali with locals"
                        .text
      ...
      body: SingleChildScrollView(
        ...
        child: VStack([
          ...
          SizedBox(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final dynamicSpacing = baseSpacing +
                    (remainingSpace > 0
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      padding: EdgeInsets.only(
                        right: index == vendorTypes.length - 1
                            ? 0
                            : dynamicSpacing,
                      ),
                      child: SizedBox(
          ...
          TravelNewsPage(
            ...
            hasMore: true,
            onLoadMore: () =>
                ref.read(welcomeControllerProvider.notifier).loadMoreBlogs(),
