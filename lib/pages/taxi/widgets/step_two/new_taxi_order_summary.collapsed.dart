        ...
        [
          VStack(
            [
              ...
              NewTaxiVehicleTypeListView(vendorType: vendorType).wFull(context),
            ],
          ),
          Divider(
              ...
              HStack(
                [
                  ...
                  VxBadge(
                    child: IconButton(
                      onPressed: () =>
                          summaryController.openCouponDialog(context),
                      icon: Icon(
                        Icons.local_offer,
                        color: Utils.systemGreyColor(true),
                      ),
                    ).box.roundedSM.color(Utils.systemGreyColor()).px8.make(),
