      ...
      Visibility(
        ...
        child: VStack([
          ...
          HStack([
            ...
            "${vm.order.orderService?.service?.category?.name}".text.semiBold.lg
                .make(),
          ]),
        ], crossAlignment: CrossAxisAlignment.end),
      ),

      // "${vm.order.vendor?.vendor_categories.length}".text.make(),
      vm.order.tatto_type_select.isNotEmptyAndNotNull &&
              vm.order.tatto_placement.isNotEmptyAndNotNull
          ? Column(
            children: [
              Divider(),
              Row(
                ...
                children: [
                  ...
                  "${vm.order.tatto_type_select}".text.medium.bold.make(),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  "${vm.order.tatto_placement}".text.medium.bold.make(),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  "${vm.order.tatto_size}".text.medium.bold.make(),
                ],
              ),
            ],
          )
