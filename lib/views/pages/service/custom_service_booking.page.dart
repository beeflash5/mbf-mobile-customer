...
import 'package:fuodz/widgets/Categoriestabs.dart';
...
class ServicesPageBooking extends StatefulWidget {
  ServicesPageBooking(this.vendorType);

  final VendorType vendorType;

  @override
  _ServicesPageBookingState createState() => _ServicesPageBookingState();
}

class _ServicesPageBookingState extends State<ServicesPageBooking> {
  @override
  ...
  Widget buildCategoriesTab(ServiceViewModel vm) {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              TextButton(
                onPressed: () {
                  NavigationService.openCategoriesPage(
