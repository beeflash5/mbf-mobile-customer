...
import 'package:fuodz/widgets/CategoriestabsBooking.dart';
...
class ServicesBookingPage extends StatefulWidget {
  ServicesBookingPage(this.vendorType);

  final VendorType vendorType;

  @override
  _ServicesBookingPageState createState() => _ServicesBookingPageState();
}
            ...
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: CategoriesTabsBooking(vm: vm),
                ),
              ),
                      ...
                      SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            final product = vm.trendingServices[index];
