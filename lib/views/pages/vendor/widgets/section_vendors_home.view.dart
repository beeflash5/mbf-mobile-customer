...
class SectionVendorsHomeView extends StatefulWidget {
  ...
  @override
  State<SectionVendorsHomeView> createState() => _SectionVendorsViewState();
}

class _SectionVendorsViewState extends State<SectionVendorsHomeView> {
  @override
