...
import 'package:fuodz/widgets/list_items/vendor_home.list_item.dart';
...
class SectionVendorsHomeViewFoods extends StatefulWidget {
  const SectionVendorsHomeViewFoods(
    this.vendorType, {
    this.title = "",
  ...
  @override
  State<SectionVendorsHomeViewFoods> createState() =>
      _SectionVendorsViewState();
}

class _SectionVendorsViewState extends State<SectionVendorsHomeViewFoods> {
  @override
            ...
            child: VStack([
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: HStack([
                    "${widget.title}".text.xl.semiBold.make().expand(),
