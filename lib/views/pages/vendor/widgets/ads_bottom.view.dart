...
class AdsBottom extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<BannersViewModel>.reactive(
      ...
      onViewModelReady: (model) => model.initialiseAds2(),
      builder: (context, model, child) {
        return model.isBusy
            ? LoadingShimmer().px20().h(150)
            : Visibility(
              visible: model.ads2.isNotEmpty,
              child: Padding(
                ...
                child: VStack([
                  ...
                  //indicators
                  // CustomVisibilty(
                  //   visible: model.ads2.length <= 10 || showIndicators,
                  //   child:
                  //       AnimatedSmoothIndicator(
                  //         activeIndex: model.currentIndex,
                  //         count: model.ads2.length,
                  //         textDirection:
                  //             Utils.isArabic
                  //                 ? TextDirection.rtl
                  //                 : TextDirection.ltr,
