  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ServiceSearchViewModel>.reactive(
      ...
      builder: (context, model, child) {
        return BasePage(
          backgroundColor:
              Colors.white, // Color(0xffE9F4F6), // context.backgroundColor,
          ...
          body: SafeArea(
            ...
            child: VStack([
              ...
              Visibility(
                visible:
                    (model.byLocation || (model.search?.byLocation ?? false)) &&
              ...
              CustomVisibilty(
                ...
                child:
                    VStack([
                      ...
                      //           final searchResult = model.searchResults[index];
                      //           if (searchResult is Service) {
                      //             return ServiceCard(service: searchResult);
                      //             // return GridViewServiceListItem(
                      //             //   service: searchResult,
                      //             //   onPressed: model.servicePressed,
                      //             // );
                      ...
                      CustomVisibilty(
                        ...
                        child:
                            CustomMasonryGridView(
                              ...
                              mainAxisSpacing: 10,
                              items:
                                  model.searchResults.map((searchResult) {
                                    //
                                    if (searchResult is Service) {
                                      if (searchResult.vendor_type_id == 13) {
                                      ...
                                      } else if (searchResult.vendor_type_id ==
                                              null &&
                                          searchResult.vendor.vendorTypeId ==
                                              13) {
                                        return HomeServicesListItemTatto(
                                          height: 360,
                                          width: double.infinity,
