...
class FavouritesHomePage extends StatelessWidget {
  const FavouritesHomePage({Key? key}) : super(key: key);
            ...
            body: ContainedTabBarView(
              ...
              views: [
                ...
                CustomListView(
                  ...
                  errorWidget: LoadingError(onrefresh: vm.fetchProducts),
                ...
                CustomListView(
                  ...
                  errorWidget: LoadingError(onrefresh: vm.fetchVendors),
                  itemBuilder: (context, index) {
