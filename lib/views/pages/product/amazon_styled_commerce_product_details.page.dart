              ...
              child: VStack([
                ...
                VStack([
                  ...
                  HStack([
                    ...
                    UiSpacer.hSpace(10),
                    "(${model.product.reviewsCount})".text
                        .color(AppColor.primaryColor)
                        .make(),
                ...
                HStack([
                  ...
                  if (model.product.showDiscount)
                    "${AppStrings.currentCurrencySymbol} ${model.product.price.convertCurrency}"
                        .currencyFormat()
                        .text
                        .color(AppColor.primaryColor)
                        .lineThrough
                  ...
                  "${AppStrings.currentCurrencySymbol} ${model.product.sellPrice.convertCurrency}"
                      .currencyFormat()
                      .text
                      .color(AppColor.primaryColor)
                      .xl2
                    ...
                    HStack(
                      [
                        ...
                        QtyStepper(
                              ...
                              min: 1,
                              max:
                                  (model.product.availableQty != null &&
