...
class SocialMediaLoginService {
  ...
  //apple login
  void appleLoginAndroid(LoginViewModel model) async {
    try {
      print("apple login --> START (ANDROID WEB FLOW)");
      ...
      print("apple login --> WAITING FOR DEEPLINK...");

      // ❌ JANGAN show loading di sini juga
    } on SignInWithAppleAuthorizationException catch (e) {
      print("apple login --> ERROR AUTH: ${e.code}");

      if (e.code == AuthorizationErrorCode.canceled) {
        print("apple login --> USER CANCEL / TAB CLOSE");

        // 🔥 ini normal, jangan stopLoading juga
        return;
      }

      model.toastError(e.message ?? "Apple login error");
    } catch (error) {
      print("apple login --> UNKNOWN ERROR: $error");
