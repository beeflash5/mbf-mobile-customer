...
class AuthRequest extends ApiService {
  //
  ...
  Future<ApiResponse> loginHpRequest({
    required String phone,
    required String password,
  }) async {
    final apiResult = await post(Api.login_handphone, {
      "phone": phone,
      "password": password,
      "tokens": await FirebaseTokenService().getDeviceToken(),
    });
  ...
  Future<ApiResponse> updatePassword({
    ...
    final apiResult = await put(Api.updatePassword, {
      "_method": "PUT",
      "password": password,
