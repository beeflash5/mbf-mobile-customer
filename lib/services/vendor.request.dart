...
class VendorRequest extends ApiService {
  //
  Future<List<Vendor>> vendorsRequest({
    ...
    //
    final apiResult = await get(Api.vendors, queryParameters: queryParameters);
  ...
  Future<ApiResponse> vendorGetTableUse(
    int vendor_id,
    String date,
    int? order_id,
  ) async {
  ...
  Future<ApiResponse> vendorGetDateUse(int vendor_id) async {
    //
    final apiResult = await get(
      "${Api.vendor_date_use}",
      queryParameters: {"vendor_id": vendor_id},
    );
    final apiResponse = ApiResponse.fromResponse(apiResult);
    if (apiResponse.allGood) {
      return apiResponse;
  ...
  Future<ApiResponse> vendorGetTimeUse(int vendor_id, String date) async {
    ...
    final apiResult = await get(
      "${Api.vendor_time_use}",
      queryParameters: {"vendor_id": vendor_id, "date": date},
    );
    final apiResponse = ApiResponse.fromResponse(apiResult);
    if (apiResponse.allGood) {
      return apiResponse;
  ...
  Future<ApiResponse> vendorReschulde({
    required String schedule_date,
    required String schedule_time,
    required String selected_table_id,
    required int order_id,
  }) async {
    //
    final apiResult = await post(Api.vendor_reshedule, {
