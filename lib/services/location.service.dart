...
class LocationService {
  ...
  //     // iOS tetap tampilkan penjelasan juga
  ...
  //   // 🔥 KHUSUS iOS: handle deniedForever
  //   if (Platform.isIOS &&
  //       _permissionGranted == PermissionStatus.deniedForever) {
  //     // JANGAN paksa ke settings otomatis
  //     // biarkan UI kamu yang arahkan user
  //     return;
  //   }

  //   // kalau belum granted → stop
  ...
  //     if (Platform.isIOS) {
  //       // ❗ iOS: jangan requestService → akan buka Settings
  //       return;
  //     } else {
  //       // Android masih boleh
