...
class SearchRequest extends ApiService {
  //
  ...
  Future<SearchData> getSearchFilterData({int? vendorTypeId}) async {
    final apiResult = await get(
      Api.searchData,
      queryParameters: {"vendor_type_id": vendorTypeId},
    );
  ...
  Future<List<dynamic>> searchRequest({
    ...
    if (search.deliveryAddress != null) {
      params = {
        ...params,
        "latitude": search.deliveryAddress?.latitude,
        "longitude": search.deliveryAddress?.longitude,
      };
    }
