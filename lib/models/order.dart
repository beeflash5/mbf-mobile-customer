...
class Order {
  Order({
    ...
    this.attachments,
    this.fees,
    this.tatto_placement,
    this.tatto_size,
    this.tatto_type_select,
    this.attach,
    this.dp,
    this.sisa,
    this.dp_status,
    ...
    this.can_reschedule = false,
    this.check_in = 0,
    this.confirmation_note,
    this.confirmation_customer,
  });
  ...
  factory Order.fromJson(dynamic json) {
    ...
    return Order(
      ...
      tatto_size: json["tatto_size"] != null ? json["tatto_size"] : null,
      tatto_type_select:
  ...
  Map<String, dynamic> toJson() => {
    ...
    "confirmation_customer": confirmation_customer,
  };
  ...
  void merge(Order other) {
    ...
    this.reser_guest = other.reser_guest;
    this.reser_table = other.reser_table;
  }
