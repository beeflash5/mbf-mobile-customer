...
class OptionGroup {
  ...
  factory OptionGroup.fromJson(Map<String, dynamic> json) => OptionGroup(
    ...
    multiple:
        json["multiple"] == null ? 0 : int.parse(json["multiple"].toString()),
    required:
        json["required"] == null ? 0 : int.parse(json["required"].toString()),
    isActive:
        json["is_active"] == null ? 0 : int.parse(json["is_active"].toString()),
