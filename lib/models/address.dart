  ...
  */
  ...
  Address fromMap(Map map) {
    ...
    return new Address(
      ...
      adminArea: getTypeFromAddressComponents(
        "administrative_area_level_1",
        map,
      ),
      subAdminArea: getTypeFromAddressComponents(
        "administrative_area_level_2",
        map,
      ),
    );
  ...
  Address fromServerMap(Map map) {
    String? addressLine = map['formatted_address'] ?? map["description"];
    addressLine ??= map["description"];
    String? featureName;
    if (map["structured_formatting"] != null) {
      featureName =
    ...
    return new Address(
      coordinates:
          map["geometry"] != null
              ? new Coordinates.fromMap(map["geometry"]["location"])
              : null,
      addressLine: map['formatted_address'] ?? map["description"],
  ...
  String getTypeFromAddressComponents(
    ...
    if (searchResult["address_components"] != null) {
      ...
      throw "address_components is missing";
    }
    return result;
  }
}
