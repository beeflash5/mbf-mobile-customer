...
class Vendor {
  Vendor({
    ...
    required this.vendor_categories,
  ...
  List<VendorCategory> vendor_categories;
  List<Fee> fees;
  List<String> cities;
  List<String> states;
  ...
  factory Vendor.fromJson(
    ...
    Vendor vendor = Vendor(
      ...
      vendor_categories:
          json["vendor_categories"] == null
              ? []
              : List<VendorCategory>.from(
                json["vendor_categories"].map(
                  (x) => VendorCategory.fromJson(x),
                ),
              ),
      fees:
          json["fees"] == null
