...
class CheckOut {
  ...
  factory CheckOut.fromJson(Map<String, dynamic> json) {
    ...
    // final double dp =
    //     json["dp"] == null ? 0.00 : double.parse(json["dp"].toString());
    // final double sisa = total - dp;
    return CheckOut(
      subTotal:
          json["sub_total"] == null
              ? 0.00
      ...
      dp: json["dp"] == null ? 0.00 : double.parse(json["dp"].toString()),
      sisa: json["sisa"] == null ? 0.00 : double.parse(json["sisa"].toString()),
    );
  }
